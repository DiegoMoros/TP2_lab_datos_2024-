...
reporte2 = cb.reporte_clasificacion_binaria(pixeles, combinacion_atributos_5)
...
# Gráfico de exactitud con subconjuntos mas grandes
cb.grafico_exactitud(reporte2["accuracy_scores"], combinacion_atributos_5)

# Matrices de confusión
cb.graficar_matrices_confusion(reporte["confusion_matrices"], combinacion_atributos_3)

cb.graficar_matrices_confusion(reporte2["confusion_matrices"], combinacion_atributos_5)
